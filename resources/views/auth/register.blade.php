            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 style="font-weight: 200" class="mb-0">{{ __('Registrieren') }}</h4>
                    </div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="name"
                                       class="col-md-4 col-form-label text-md-right">{{ __('Voller Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Firma') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Straße Nr.') }}</label>
                            ...
                            <div class="col-md-2">
                                <input id="street_no" type="text" class="form-control @error('street_no') is-invalid @enderror" name="street_no" value="{{ old('street_no') }}" required autocomplete="street_no">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('PLZ') }}</label>
